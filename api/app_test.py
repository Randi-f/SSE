...
# def test_max():
#     assert (
#         process_query("Which of the following numbers is the largest: 98, 59, 31?")
#         == "98"
#     )
...
#     assert (
#         process_query(
#             "Which of the following numbers is both a square and a cube: 8, 4, 64"
#         )
#         == "64"
#     )
